...
namespace SKSchoolApi.Database
{
    public class DB
    {
        ...
        public DataSet SupportMaster(string command, Support support)
        {
            using (SqlConnection con = new SqlConnection(constr))
            {
                try
                {
                    String query = "usp_Support";
                    SqlCommand com = new SqlCommand(query, con);
                    con.Open();
                    com.CommandType = CommandType.StoredProcedure;
                    com.Parameters.AddWithValue("@command", command);
                    com.Parameters.AddWithValue("@intSchool_id", support.intSchool_id);                   
                    SqlDataAdapter da = new SqlDataAdapter(com);
                    DataSet ds = new DataSet();
                    da.Fill(ds, "APKVersion");
                    return (ds);
        ...
        public DataSet BankMaster(string command, BankMaster bankMaster)
        {
            using (SqlConnection con = new SqlConnection(constr))
            {
                try
                {
                    String query = "usp_bankDetails";
                    SqlCommand com = new SqlCommand(query, con);
                    con.Open();
                    com.CommandType = CommandType.StoredProcedure;
                    com.Parameters.AddWithValue("@command", command);
                    com.Parameters.AddWithValue("@intSchool_id", bankMaster.intSchool_id);
                    SqlDataAdapter da = new SqlDataAdapter(com);
                    DataSet ds = new DataSet();
                    da.Fill(ds, "APKVersion");
                    return (ds);
